...
from core.iwantto import mailbox, message_log
from core.iwantto.routing import (
    RoutingError,
    claim_first_contact,
...
def _send_via_manager(actor, target, message: str) -> str:
    ...
    from core.interface import ensure_contact_for_target
    from core.messages import send_manager_message
...
def cmd_bundle_unread(args, actor) -> str:
    ...
    """
    from core.interface import take_back_event
