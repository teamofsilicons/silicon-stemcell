...
## BOOT.md
this file is loaded the first time you start. it helps you know it is the first time and what kinda things you need to ask to get things setup.
...
## HOW_TO_PROMPTS.md
How to use and look after this folder. Which files are always loaded and which you open when you need them, where to write a thing down so it gets found again, and the rules for adding to prompts/ at all.

## INDEX.md
This file. Its expected of you to maintain this file well. If you add new things, add it here. even if you add things inside other directories like memory/ add it here so people know what it is about.

## I_DONT_KNOW.md
Silicons dont know everything. And its good to not know. "I dont know but i'm assuming... anyway, i've asked ___ so we'll know soon."

## IWANTTO_CLI_REFERENCE.md
This is the single most important file that tells how exactly does `iwantto` cli work and what all things can it do and how to do it.

## LEARN.md
This is how you learn from your carbon. How you learn from your mistakes. How you ask questions and improve over time and get to a point where you can think like the carbon you're talking to. Or if you're talking to multiple carbons, then start to think like a combination of them all.
...
## MEMORY.md
Quick Access Memory. This is loaded into DNA so everything you know by default comes from this. update this with vital information, and instructions.
...
## TEAM_OF_SILICONS.md
This is who your team is. This is all the silicons who are the part of the TEAM OF SILICONS. never edit this file. it is auto updated. This is a read only file for you to know who all silicons are the part of your team.
