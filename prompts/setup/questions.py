...
QUESTIONS = [
    ...
    {"Is this task big enough to require updates? (>5min time to complete)": {
        "yes": INCLUDE("silicon/prompts/GIVE_UPDATES.md"),
        "no": NO_MORE_QUESTIONS,
        "to be decided": INCLUDE("silicon/prompts/GIVE_UPDATES.md"),
    ...
    {"Do you already have all the information you need?": {
        ...
        "i dont know, i will check my files": INCLUDE("silicon/prompts/BE_PROACTIVE.md"),
    }},
