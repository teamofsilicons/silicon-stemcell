...
Version 4.0.0 verification is in progress. The records below describe previously completed 3.x checks and do not establish Windows support for the new release.
