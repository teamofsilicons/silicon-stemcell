...
from diagnostics.retention import maybe_prune
    ...
    def __exit__(self, exc_type, exc, tb):
        ...
        try:
            if exc_type is not None:
                ...
                try:
                    from interface.progress import redact_diagnostic_text
...
class Diagnostics:
    ...
    def register_pending_context(cls, carbon_id, context) -> None:
        ...
        This registry is process-local by design: ``interface.messages`` queues and
