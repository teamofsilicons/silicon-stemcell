...
from silicon.loop import handle_commands
from silicon.tools.registry import _manager_output_for_log
from silicon.tools.registry import _rate_limit_reply_text
from silicon.tools.registry import _tool_results_for_log
from silicon.tools.registry import execute_all_tools
from silicon.tools.registry import is_only_do_nothing
from silicon.tracing import _begin_manager_trace
from silicon.tracing import _close_manager_trace
from silicon.tracing import _instrumented_manager_call
from silicon.tracing import _is_terminal_brain_failure
from silicon.tracing import _make_mid_stream_handler
from silicon.tracing import _make_provider_progress_handler
from silicon.tracing import _trace_correlation
from silicon.tracing import _work_lifecycle_is_visible
import json
import time
from silicon import (
        ...
        if pending:
            ...
            for carbon_id in pending:
                ...
                if trace is None:
                    continue
                try:
                    with trace.span("silicon.iteration_limit") as span:
                        span.status = "error"
                        span.set_meta(
